    ...
    <div class="container mb-3">
        ...
        <form action="{{ route('dashboard') }}" method="post">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="mata_kuliah" id="mataKuliah" class="form-control @error('mata_kuliah') is-invalid @enderror" value="{{old('mata_kuliah')}}">
                @error('mata_kuliah')
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="nama_dosen" id="namaDosen" class="form-control @error('nama_dosen') is-invalid @enderror" value="{{old('nama_dosen')}}">
                @error('nama_dosen')
                <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
